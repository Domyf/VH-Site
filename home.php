    ...
    <body>
        <div class="car-list-menu">
            ...
            <div style="float:right;">
                <form action="home.php" method="POST" style="margin-right: 10px; font-size: 18px;">Dal<input type="date" name="start" min="2000-01-01" class="datepicker">
        ...
        <?php
            include 'connect.php';if (isset($_POST["start"]) && isset($_POST["end"])) {
                //QUERY 1
                $inizio = $_POST["start"];
                $fine = $_POST["end"];
                
                $sql = "SELECT * FROM Auto WHERE Targa IN (SELECT Auto FROM Noleggi WHERE );";
            } else {
